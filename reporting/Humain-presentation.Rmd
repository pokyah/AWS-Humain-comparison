...
* The scatter still presents a trend going from positive bias to negative bias <i class="fa fa-hand-point-right"></i>. The ventilation system is not the only explanation to the negative bias. The sensitivity of the sensors themselves (and/or non-linear differences in radiation transfer effects from the shelters towards the sensors) could also expain the observed differences.
